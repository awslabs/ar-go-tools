...
lint: **/*.go
	...
	nilaway --test=false ./cmd/argot/... \
                         ...
                         ./analysis/summaries/... \
                         ./analysis/taint/...
	golint -set_exit_status -min_confidence 0.9 ./analysis/... ./cmd/... ./internal/...
	staticcheck ./analysis/... ./cmd/... ./internal/...

test: **/*.go
	go clean -testcache
	go test ./analysis/... ./cmd/... ./internal/...
