...
func cmdCd(tt *term.Terminal, c *dataflow.AnalyzerState, command Command, _ bool) bool {
	if c == nil {
...
func cmdExit(tt *term.Terminal, c *dataflow.AnalyzerState, _ Command, _ bool) bool {
	if c == nil {
...
func cmdLs(tt *term.Terminal, c *dataflow.AnalyzerState, command Command, _ bool) bool {
	if c == nil {
