...
func cmdCd(tt *term.Terminal, c *dataflow.FlowState, command Command, _ bool) bool {
	if c == nil {
...
func cmdExit(tt *term.Terminal, c *dataflow.FlowState, _ Command, _ bool) bool {
	if c == nil {
...
func cmdLs(tt *term.Terminal, c *dataflow.FlowState, command Command, _ bool) bool {
	if c == nil {
