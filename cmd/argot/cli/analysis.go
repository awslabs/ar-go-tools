...
func cmdShowSsa(tt *term.Terminal, c *dataflow.AnalyzerState, command Command, withTest bool) bool {
	if c == nil {
...
func cmdShowEscape(tt *term.Terminal, c *dataflow.AnalyzerState, command Command, withTest bool) bool {
	if c == nil {
...
func cmdShowDataflow(tt *term.Terminal, c *dataflow.AnalyzerState, _ Command, _ bool) bool {
	if c == nil {
...
func cmdSummary(tt *term.Terminal, c *dataflow.AnalyzerState, command Command, _ bool) bool {
	if c == nil {
...
func cmdSummarize(tt *term.Terminal, c *dataflow.AnalyzerState, command Command, _ bool) bool {
	if c == nil {
...
func cmdTaint(tt *term.Terminal, c *dataflow.AnalyzerState, _ Command, _ bool) bool {
	if c == nil {
...
func cmdBacktrace(tt *term.Terminal, c *dataflow.AnalyzerState, _ Command, _ bool) bool {
	if c == nil {
