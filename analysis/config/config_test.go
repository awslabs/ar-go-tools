...
func TestCodeIdentifier_equalOnNonEmptyFields_capabilities(t *testing.T) {
	cid1 := CodeIdentifier{Capability: "CAPABILITY_NETWORK"}
	cid1bis := CodeIdentifier{"main", "command-line-arguments", "", "b", "", "", "", "", "", "CAPABILITY_NETWORK", nil}
	checkEqualOnNonEmptyFields(t, cid1, cid1bis)
}
