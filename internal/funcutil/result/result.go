...
type Result[T any] interface {
	...
	// Error returns the error or panics if the result is a value
	Error() error
}
...
func (s ok[T]) Error() error       { panic("fatal: tried to error an ok value") }
...
func (s err[T]) Error() error           { return s.value }
